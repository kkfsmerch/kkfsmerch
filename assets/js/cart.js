...
(function(){
  ...
  function submitToGoogleSheets(payload) {
    try {
      ...
      form.method = 'POST';
      form.action = 'https://script.google.com/macros/s/AKfycbx_OuTk4MI2_tgWiQb6bKa9xrhkn0c0sfN6OQvn2YVT7NZguyim0c_qnvMtRuKZwzzqQg/exec'; // Replace with the URL that shows the working message
